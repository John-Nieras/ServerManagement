namespace ServerManagement.Models
{
        ...
        {
            new Server {  ServerId = 1, Name = "Server1", City = "Tanauan" },
            new Server {  ServerId = 2, Name = "Server2", City = "Tanauan" },
            new Server {  ServerId = 3, Name = "Server3", City = "Tanauan" },
            new Server {  ServerId = 4, Name = "Server4", City = "Tanauan" },
            new Server {  ServerId = 5, Name = "Server5", City = "Sto.Tomas" },
            new Server {  ServerId = 6, Name = "Server6", City = "Sto.Tomas" },
            new Server {  ServerId = 7, Name = "Server7", City = "Sto.Tomas" },
            new Server {  ServerId = 8, Name = "Server8", City = "Sto.Tomas" },
            new Server {  ServerId = 9, Name = "Server9", City = "Sto.Tomas" },
            new Server {  ServerId = 10, Name = "Server10", City = "Lipa" },
            new Server {  ServerId = 11, Name = "Server11", City = "Lipa" },
            new Server {  ServerId = 12, Name = "Server12", City = "Lipa" },
            new Server {  ServerId = 13, Name = "Server13", City = "Lipa" },
        };
